    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                ...
                I have been lucky enough to travel the world extensively. I have lived in Frankfurt Germany, London, Manchester UK and Dubai UAE. Currently in my free time I do yoga and bake bread.</p>
                </div>
                
                <a href="#portfolio" class="btn btn-primary btn-xl page-scroll header-btn">Go to Portfolio</a>
            </div>
        </div>
    </header>

    <section class="finasafe" id="portfolio">
        <div class="container">
            <div class="row">
   ...
   <!--  <section class="pshell">
    ...
    <section id="skills">    
        ...
        <div id="sb-container" class="sb-container">
            ...
            <div>
                <span class="sb-icon icon-cog turn"></span>
                <h5><span>HTML5</span></h5>
            </div>
            <div>
                <span class="sb-icon icon-flight"></span>
                <h5><span>CSS3</span></h5>
            </div>  
            <div>
            ...
            <div>
                ...
                <h5><span>Rails</span></h5>
            </div>  
            <div>
                <span class="sb-icon icon-mobile"></span>
                <h5><span>Laravel</span></h5>
            </div>
            <div>
    ...
    <section>
        <div class="container"> 
            <div class="row">
                <h2 class="section-heading">Further Skills</h2>
                <hr>
            </div>
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                        <img class="skillIcon" src="img/code_icon.png" alt="...">
                        <div class="caption">
                           Postgress > Wordpress <br>
                           Unix > ReST<br>
                           Git
                        </div>
                    </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                        <img class="skillIcon" src="img/designer_icon.png" alt="...">              
                        <div class="caption">
                            User Experience<br>
                            UI Design<br><br>
                        </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                        <img class="skillIcon" src="img/writer_icon.png" alt="...">
                        <div class="caption">
                            Editing<br>
                            Copy Writing<br>
                            Growth Hacking and SEO<br>
                        </div>
                    </div>
                </div>
            </div>
