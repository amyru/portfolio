<?php include("inc/header.php"); ?>
    ...
    <section class="about-ps">
    	<div class="row">
	    	<div class="col-md-4 col-md-offset-1">
				...
				<!-- <hr class="light left"> -->
				<p>Privacy Snapper is a Chrome and Firefox extension. Once installed it collects all the privacy policies and terms of services from the websites a user visits. This was created with the team at Privacy Shell Inc who believe in educating the world wide web on Online Privacy and Security.</p>
			</div>
    	...
    	<div class="row">
	    	<div class="col-md-7">
				...
				<div class="col-md-4">
					...
					<p>User experience was improved with the extension inline installation. After a user has signed up for the service through the dashboard they are brought to this page to install the plugin. </p>
				</div>
			</div>
			<div class="row">
				<div class=" col-md-4">
    ...
    <section class="ex-update">
    	<div class="text-center">
    		<h3>Stripe integration for an ecommerce solution</h3>
    		<hr class="light">
    	</div>    	
    	<div class="row">
    		<div class="col-md-11 col-offset-4">
    			<p class="ux-payment text-center">With over 68% of carts abandoned, I wanted to design a payment form that instilled credibility and payment success. In my research, trying to promote trust when the customer is just about to enter their card details, is the most profitable. In mentioning the payment provider we use and a 100% money back guarantee I hoped to create a trustworthy appearing form.<br><br>According to research consumers are more likely to click on a red button, so this is what I based the colour scheme on. I also considered the amount of form fileds necessary for a credible and facile experience.</p>
    		</div>
    	</div>
    </section>
